...
public class ProgramObject {
   ...
   public ProgramObject(GL3 gl3) {
       _progId = 0;
   }

   public ProgramObject(GL3 gl3, String shadersFilepath, String vertexShader, String fragmentShader) {
   ...
   public ProgramObject(GL3 gl3, String shadersFilepath, String[] vertexShaders, String[] fragmentShaders) {
